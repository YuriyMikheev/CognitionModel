...
public class CSVDataSetTest {
    ...
    public void CSVtest() throws IOException {
       ...
       // System.out.println(csvDataSet.getHeader().getTuples().get(0).toString());
        ...
        assertTrue(csvDataSet.getRecords().get(0).getTuples().get(0).type == TupleElement.Type.String);
        assertTrue(csvDataSet.getRecords().get(0).getTuples().get(1).type == TupleElement.Type.Int);
        assertTrue(csvDataSet.getRecords().get(0).getTuples().get(2).type == TupleElement.Type.Double);
