...
public class IterativeDecomposer implements Decomposer {
    ...
    public IterativeDecomposer(InvertedIndex invertedIndex, String predictingField, boolean modelcashed) {
        this(invertedIndex, predictingField, modelcashed, 300, null, false);

    }

    public IterativeDecomposer(InvertedIndex invertedIndex, String predictingField, boolean modelcashed, int maxDepth, Function<Agent, Boolean> agentFilter){
        this(invertedIndex, predictingField, modelcashed, maxDepth, agentFilter, false);
    }
    public IterativeDecomposer(InvertedIndex invertedIndex, String predictingField, boolean modelcashed, int maxDepth, Function<Agent, Boolean> agentFilter, boolean mustHavePredictingField){
